...
select flowerName,amount from customerOrder
natural join customer
natural join order_has_flower
natural join flower
where firstname='Mary' and lastname='Jones';

select flowerName,amount, amount*unitPrice as total from customerOrder
natural join customer
natural join order_has_flower
natural join flower
where firstname='Mary' and lastname='Jones';
...
select flower.flowerName,
    ...
    order_has_flower.amount*flower.unitPrice as total 
from customerOrder
natural join customer
natural join order_has_flower
natural join flower
where customer.firstname='Mary' and customer.lastname='Jones';